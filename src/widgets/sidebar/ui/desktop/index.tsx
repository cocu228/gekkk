            ...
            <NavLink onClick={NavLinkEvent} to={"wallet/EURG"}>
                <div className={`${styles.Item}`}>
                    ...
                    <div className="col flex items-center justify-center flex-col pl-5">
                        ...
                        <div className="row w-full font-mono">
                            <span
                                className={styles.Sum}>{(eurWallet && toLocaleFiatRounding(eurgWallet.availableBalance?.toNumber())) ?? '-'} EURG</span>
                        </div>
                        {eurWallet && <div className="row w-full flex justify-between">
                            <div>
