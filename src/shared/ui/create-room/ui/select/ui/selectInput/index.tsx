...
const SelectInput: FC<ISelectInputProps> = ({
    ...
    if (iconCode === null) {
      return (
        <IconApp
          code='t08'
          size={10}
          className={`${!isOpen ? "rotate-[90deg]" : "rotate-[-90deg]"}`}
  ...
  return (
    <div
      className={`${styles.SelectInputContainer} ${styles.SelectInputContainerSearchable} ${
        isOpen ? styles.SelectInputContainerOpen : ""
      }`}
