...
import { apiTokensNetworks, apiListAddresses } from "@/shared/(orval)api/gek";
import {
  getChosenNetwork,
...
const NetworkProvider = ({ children, ...props }: IProps) => {
  ...
  return (
    <CtxWalletNetworks.Provider value={{ ...state, setNetworkType: setNetworkId, setLoading, setRefresh }}>
      {children}
