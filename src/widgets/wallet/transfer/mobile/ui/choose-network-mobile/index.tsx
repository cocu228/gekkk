            ...
            >
                <Select
                    ...
                    placeholder={<div onClick={()=>{setNetwork(null)}} className="flex w-full text-[12px] text-[#3A5E66] h-full justify-start items-center">
                        ...
                        </span> : loading ? <div className="flex items-center justify-center w-full relative"><Loader className="w-[24px] h-[24px]"/></div> : !network ? <span className="inline-flex justify-center w-full text-[10px] text-[var(--gek-mid-grey)]">{t("choose_network_type")}</span> : <span className="text-[12px] text-[#3A5E66]">
