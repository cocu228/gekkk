                        ...
                        <NavLink to={"/faq"}>
                            <div className={styles.FAQ}>
                                ...
                                <div className={styles.Main}>
                                    ...
                                    <div
                                        className={styles.MainDescription}>{t("to_find_answers_to_common_questions_open_the_faq")}</div>
                                </div>
                        ...
                        <div className={styles.Email}>
                            <div className={styles.Icon}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42"
                                    ...
                                    <rect x="12.5811" y="17.5" width="18" height="12" rx="2" stroke="#29354C"
                                          strokeWidth="2"/>
                                    <line x1="13.1358" y1="20.6679" x2="22.1358" y2="26.6679" stroke="#29354C"
                                          strokeWidth="2"/>
                                    <line x1="21.0264" y1="26.6679" x2="30.0264" y2="20.6679" stroke="#29354C"
                                          strokeWidth="2"/>
                                    <rect x="16.0811" y="11" width="11" height="11" rx="1.5" fill="white"
                                          stroke="#29354C"/>
                                ...
                                <defs>
                                    <filter id="filter0_d_558_19277" x="0" y="0" width="35" height="35"
                                        ...
                                        <feBlend mode="normal" in2="BackgroundImageFix"
                                                 result="effect1_dropShadow_558_19277"/>
                                        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_558_19277"
                                                 result="shape"/>
                                    </filter>
                                </defs>
                            </svg>
