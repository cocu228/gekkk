 ...
 */
import type { InvestmentsTypeEnum } from "./investmentsTypeEnum";

export interface GetDepositOut {
  /** Сумма открытия депозита */
  amount?: number;
  /** Сумма текущая */
  cur_amount?: number;
  /**
  ...
  /** Дата закрытия депозита в UTC */
  date_end?: string;
  /** Дата создания депозита */
  date_start?: string;
  dep_type?: InvestmentsTypeEnum;
  /** Идентификатор депозита */
  id?: number;
  /**
   * Курс связанной валюты, закрытия. Если ещё не закрыт, активный депозит, то null.
   * @nullable
   */
  link_cur_end_rate?: number | null;
  /** Курс связанной валюты, стартовый */
  link_cur_start_rate?: number;
  /**
   * Cвязанная валюта фиксации курса - для депозитов с доходностью зависимой от курса валют
   * @nullable
   */
