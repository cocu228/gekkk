    ...
    return <>
        <header className={styles.Header}>
            <div className={styles.ContainerLogo}>
                <a onClick={() => navigate('/')}>
                    {global.VITE_APP_TYPE === "GEKKOIN" ?
                        <img src="/img/gko-logo.svg" width={165} height={55} alt="logo"/> :
                        <svg width="100%" height="40px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 137 45"
                             fill="none"
