...
function Exchange() {
  ...
  const { addRoom: addExchangeRoom, removeRoom: closeExchangeRoom } = storeListExchangeRooms(state => state);
  ...
  const getHeadTitle = () => {
    switch (roomType) {
      case "default":
        return (
          <DropdownC isOpen={roomInfoModal.isModalOpen} trigger={<span>{t("exchange.title")}</span>}>
            <DropdownCItem onClick={roomInfoModal.showModal} icon={<IconApp color='red' code='t33' size={20} />}>
      ...
      case "creator":
        return (
          <>
            ...
            <button className='underline text-accent' onClick={roomInfoModal.showModal}>
    ...
    <div className=' '>
          ...
          <div className={`gap-x-[10px] bg-white ${styles.Grid}`}>
            <div className='h-full flex flex-col justify-between'>
              ...
              <div className='mt-3 md:mt-2 flex flex-col gap-[5px]'>
                <div className={`${styles.FieldPreTitle} ml-[10px]`}>{t("price")}:</div>
            ...
            <div className='px-5 mt-4'>
              ...
              <div className='flex flex-col mt-6 md:mt-[20px] gap-1 md:gap-[15px]'>
                ...
                <div className='flex justify-between gap-4'>
                  <Button disabled={loading} className='w-full' onClick={createOrder}>
                    {t("confirm")}
                  </Button>
      ...
      {md && (
        <div className='w-full rounded-lg'>
          <span className='text-[12px] block ml-[19px] mt-[2px] text-[#29354C] font-bold'>
            {t("last_transactions")}
          </span>
      ...
      <Modal
        title={`${roomType === "creator" ? t("exchange.close") : t("exchange.leave")} ${t(
          "exchange.private_exchange_room"
        )}`}
      ...
      >
        <div className='text-sm'>
          ...
          {roomType === "creator" ? t("exchange.close_private_exchange") : t("exchange.leave_private_exchange")}
        ...
        <div className='mt-8 sm:mt-4 flex justify-center'>
          <Button size='lg' className='w-full' onClick={closeRoom}>{`${
