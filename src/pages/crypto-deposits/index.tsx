            ...
            <div className="substrate flex flex-col">
                <section className={!md ? "max-w-[400px]" : ""}>
                    ...
                    <div style={md ? {border: "1px solid #B4C0CD", borderRadius: "4px 4px 0px 0px"} : {}}
                        ...
                        <Button gray size="sm"
                                className="!text-black !py-2 md:!py-1 md:!text-fs10 !bg-[#DEE2E73D] !py-2 !text-sm !font-normal whitespace-nowrap !h-[auto]">Open
                            deposit</Button>
                    </div>
                </section>
                <section>
...
const Row = ({bgGray = false, val, md = false}) => {
    ...
    return <div
        ...
        <div className="col h-full">
            <div className="row mb-2 flex items-start">
                <div data-text={"Rate grows"} className="col ellipsis inline-grid">
                    <p className="text-gray-400 md:!text-fs12 whitespace-nowrap">Rate grows</p>
                </div>
            </div>
            <div className="row">
        ...
        <div className="col h-full">
            <div className="row mb-2 flex items-start">
                <div data-text={"Rate drops"} className="col ellipsis inline-grid">
                    <p className="text-gray-400 md:!text-fs12 whitespace-nowrap">Rate drops</p>
                </div>
            </div>
            <div className="row">
        ...
        <div className="col">
            <Button gray size="sm"
                    className="!text-black !py-2 md:!py-1 md:!text-fs10 !text-sm !font-normal whitespace-nowrap !bg-[#DEE2E73D] !rounded-[20px] text-[14px] !h-[auto]">Open
                deposit</Button>
        </div>
    </div>
}
