...
function DepositStats({startingRate, currentRate, course, income, disabled}: IDepositStats) {
    return (
        <div className={`wrapper flex justify-between rounded p-4 pr-12 pb-8 mb-10 bg-gray-100 w-full ${disabled ? 'grayscale' : ''} md:flex-col md:gap-8 md:order-1`}>
            <div>
                <div className='flex gap-3 items-center mb-3 md:mb-1'>
                    <img width={24} height={24} src="/img/icon/DepositStartingRateIcon.svg" alt="deposit starting rate"/>
                    <p className='text-gray-400 font-medium md:text-sm'>Starting rate</p>
                </div>
            ...
            <div>
                <div className='flex gap-3 items-center mb-3 md:mb-1'>
                    ...
                    <p className='text-gray-400 font-medium md:text-sm'>Current rate</p>
                </div>
            ...
            <div>
                <div className='flex gap-3 items-center mb-3 md:mb-1'>
                    ...
                    <p className='text-gray-400 font-medium md:text-sm'>Course difference</p>
                </div>
