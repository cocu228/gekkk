...
const StructedDepositStrategies: Array<StructedDepositStrategy> = [
    {
        ...
        descriptionLong: <>
            ...
            good for conservative investors and beginners as it excludes any
            risks associated with a fall of cryptocurrency rate.
        </>
    },
    {
        id: 20,
        ...
        descriptionLong: <>
            <b>Balanced strategy</b> - full or partial capital
            protection; increased potential for returns along
            with the minimal risk level.
        </>
    },
    {
        id: 30,
        ...
        descriptionLong: <>
            <b>Dynamic strategy</b> - partial capital protection;
            extremely high potential for returns along with the
