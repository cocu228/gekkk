 ...
 * Generic electronic key multi-cryptocurrency broker wallet platform with a built-in exchange.<br/>
                    Build version 2.0.3-20231123-0919.5186<br/><br/>
...
import type {
  ...
  GetGekV1WalletPushRefNumberParams,
  GetHistoryTrasactionOutArrayApiResponse,
...
import getGekV1TokensNetworksMutator from '../../lib/(cs)axios-new';
import postGekV1ApplyCodeMutator from '../../lib/(cs)axios-new';
import postGekV1CancelCodeMutator from '../../lib/(cs)axios-new';
import postGekV1CreateTxCodeMutator from '../../lib/(cs)axios-new';
...
import getGekV1MarketGetRatesMutator from '../../lib/(cs)axios-new';
import getGekV1MarketGetTradeInfoMutator from '../../lib/(cs)axios-new';
import getGekV1MarketGetOrdersMutator from '../../lib/(cs)axios-new';
import postGekV1MarketCreateOrderMutator from '../../lib/(cs)axios-new';
import postGekV1MarketCancelOrderMutator from '../../lib/(cs)axios-new';
import getGekV1MarketListRoomsMutator from '../../lib/(cs)axios-new';
...
import getGekV1WalletGetInfoMutator from '../../lib/(cs)axios-new';
import getGekV1WalletPushRefNumberMutator from '../../lib/(cs)axios-new';
import getGekV1WalletGetCardsMutator from '../../lib/(cs)axios-new';
import getGekV1WalletGetProgramsMutator from '../../lib/(cs)axios-new';
import getGekV1WalletGetBalanceMutator from '../../lib/(cs)axios-new';
import getGekV1WalletCreateAddressMutator from '../../lib/(cs)axios-new';
import getGekV1WalletListAddressesMutator from '../../lib/(cs)axios-new';
import postGekV1WalletCreateWithdrawMutator from '../../lib/(cs)axios-new';
import postGekV1WalletUpdateTxPartnerInfoMutator from '../../lib/(cs)axios-new';
import getGekV1WalletGetHistoryTransactionsMutator from '../../lib/(cs)axios-new';
...
/**
 * Курсы загружаются с внешних бирж и представляют собой лучшее текущее предложение курса(среднее между предложением и спросом).
Если нет прямого обмена, то высчитываются через кросс курсы синтетических пар.
Если данные по обмену устарели или не доступны то возвращяется курс 0.
...
/**
 * @summary Отправляет данные банковской транзакции для ускорения синхронизации
 */
export const apiPushRefNumber = (
    params?: GetGekV1WalletPushRefNumberParams,
 options?: SecondParameter<typeof getGekV1WalletPushRefNumberMutator>,) => {
      return getGekV1WalletPushRefNumberMutator<StringApiResponse>(
      {url: `/gek/v1/wallet/push_ref_number`, method: 'get',
        params
    },
      options);
    }
...
/**
 * @summary История транзакций клиента в заданном временном промежутке или условиях фильтрации. Не более 100 за запрос
 */
export const apiGetHistoryTransactions = (
 ...
 options?: SecondParameter<typeof getGekV1WalletGetHistoryTransactionsMutator>,) => {
      return getGekV1WalletGetHistoryTransactionsMutator<GetHistoryTrasactionOutArrayApiResponse>(
...
export type ApiPushRefNumberResult = NonNullable<Awaited<ReturnType<typeof apiPushRefNumber>>>
