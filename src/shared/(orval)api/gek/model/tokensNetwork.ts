...
export interface TokensNetwork {
  bonus_balance?: number;
  /**
   * Название сети движения средств
   * @nullable
   */
  contract_name?: string | null;
  /** Идентификатор транспортной сети */
  id?: number;
  /** вариант выбора по умолчанию */
  is_default?: boolean;
  /** Нужно ли заполнять доп информацию(например id клиента) в тег при пополнении через эту сеть */
  is_memo?: boolean;
  /** Признак возможности пополнения/вывода */
  is_operable?: boolean;
  /** Максимальный вывод */
  max_withdraw?: number;
  /** Размер минимального пополнения */
  min_topup?: number;
  /** Минимальный вывод */
  min_withdraw?: number;
  /**
  ...
  /** Тип сети */
  network_type?: number;
  /** Комиссия на операцию вывода через данную сеть (в процентах) */
  percent_fee?: number;
  /**
   * Адрес горячего кошелька по-умолчанию
   * @nullable
   */
  token_hot_address?: string | null;
  /**
   * Название токена в сети
   * @nullable
   */
  token_name?: string | null;
  /**
   * Символ токена в сети
   * @nullable
   */
  token_symbol?: string | null;
  /** Комиссия на операцию вывода через данную сеть, фикс */
  withdraw_fee?: number;
}
