...
import { toLocaleCryptoRounding } from "@/widgets/sidebar/model/helpers";
                ...
                <div className={styles.WalletInfoContainer}>
                    ...
                    <div className={styles.WalletInfoMain}>
                        <div className={styles.WalletInfoMainText + " " + styles.WalletInfoMainTextFree}>
                            ...
                            <span>
                                {toLocaleCryptoRounding(balance?.free_balance ?? 0, decimalPrec, isEUR ? 2 : decimalPrec)}
                            </span>
                        </div>
                        ...
                        <div className={styles.WalletInfoMainText + " " + styles.WalletInfoMainTextIncome}>
                            ...
                            <span>
                                <div>+{toLocaleCryptoRounding(balance?.lock_in_balance ?? 0, decimalPrec, isEUR ? 2 : decimalPrec)}</div>
                            </span>
                        </div>
                        <div className={styles.DashedLine}></div>
                        ...
                        <div className={styles.WalletInfoMainText + " " + styles.WalletInfoMainTextOutcome}>
                            ...
                            <span>
                                <div>-{toLocaleCryptoRounding(balance?.lock_out_balance ?? 0, decimalPrec, isEUR ? 2 : decimalPrec)}</div>
                            </span>
                        </div>
                        <div className={styles.DashedLine}></div>
                        ...
                        <div className={styles.WalletInfoMainText + " " + styles.WalletInfoMainTextOrders}>
                            ...
                            <span className={styles.LockOrders}>
                                ...
                                <div> {toLocaleCryptoRounding(balance?.lock_orders ?? 0, decimalPrec, isEUR ? 2 : decimalPrec)}</div>
                            </span>
                        </div>
                        <div className={styles.DashedLine}></div>
