      ...
      <div className={styles.ContainerLogo}>
        <a onClick={() => navigate("/")}>
          {IS_GEKKARD_APP() ? (
            ...
            <img src='/img/gekwallet_logo.svg' alt='logo' />
          ) : (
