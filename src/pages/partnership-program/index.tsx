...
const ContentDescription = () => {
  ...
  return (
    <>
          ...
          <div className='row'>
            <ul className='leading-6'>
              <li className='mb-2 leading-6'>
                <span className='font-semibold leading-6'>• 2% {t("partnership_program.per_annum")}</span>
                <br />
                {t("partnership_program.monthly_balance_first_year")}
              </li>
              <li className='leading-6'>
                <span className='font-semibold leading-6'>• 1% {t("partnership_program.per_annum")}</span>
                <br />
      ...
      <div className='row mb-6'>
        <div className='col info-box-warning font-medium leading-6'>{t("partnership_program.bring_your_friends")}</div>
      </div>
      <div className='row'>
        <div className='col'>
...
const PartnershipProgram = () => {
  ...
  return (
    <div className='wrapper h-inherit w-full'>
      <PageHead subtitle={t("partnership_program.subtitle")} title={t("partnership_program.title")} />
      <div className='wrapper grid grid-cols-5 xl:grid-cols-1 gap-2 xl:gap-0'>
        <div className={`${!md ? "substrate" : "bg-white -ml-4 -mr-4 pl-4 pr-4"} col-span-3 z-10 -xl:rounded-r-none`}>
          {xl && <ContentDescription />}
          <ContentMain />
        </div>
        {!xl && (
          <div
            className={`substrate text-sm h-full -ml-4 z-0 col-span-2 text-gray-600 ${
