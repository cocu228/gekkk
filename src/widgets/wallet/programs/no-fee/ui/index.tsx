    ...
    <div className=' md:mx-[-10px]'>
      <div className='bg-[#fff] md:p-[5px_20px] md:rounded-[8px]'>
        ...
        <div className={styles.NoFeeTable}>
          ...
          <div className={styles.AtTheEndText}>{t("end_of_the_program_term", { currency: currency.$const })}</div>
        </div>
      </div>
...
interface INoFeePropertiesProps {
  endDate: any;
  startDate: any;
  templateTerm: any;
  t: TFunction;
...
function NoFeeProperties({ endDate, startDate, templateTerm, t }: INoFeePropertiesProps) {
  return (
    <>
      <div className='row mb-2'>
        <div className='col'>
