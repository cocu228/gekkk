...
0 = None, 1 = WithdrawBlock, 2 = TopUpBlock, 4 = ExchangeBlock, 8 = InnerTransferBlock, 16 = InvestBlock, 32 = WalletBlock, 64 = AllTokensNetworks, 256 = GkeBonusBlock, 272 = JuridicalBlock, 319 = BlockAll, 512 = BankClientClosed, 33554432 = IsJuridical, 67108864 = IsJuridicalGekkardPro, 1073741824 = Deleted
 */
