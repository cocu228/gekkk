...
/**
 * Данные для создания кода внутреннего перевода
 */
export interface CreateTxCodeIn {
  /** Объем операции */
  amount?: number;
...
Unique transaction identifier. ⚠ Note that you should generate new unique id for each withdrawal request. */
  ...
  /** Добавление информации о дате и времени создания(до минут) для создания ограничений по времени (работает сутки).
Увеличивает длинну кода. */
  timeLimit?: boolean;
  typeTx?: CodeTypeEnum;
}
