    ...
    <div className='wrapper'>
      <div className='row mb-8 flex flex-col gap-2 md:gap-1 font-medium info-box-warning'>
        ...
        <div className='col text-xs'>
          <span>
            <b>*{t("note")}</b>: {t("exchange_fee")} <b>1,5%</b>
      ...
      {localErrorInfoBox && <div className='py-5'>{localErrorInfoBox}</div>}
      ...
      <Modal isModalOpen={isModalOpen} onCancel={handleCancel} title={t("withdraw_confirmation")}>
        ...
        <div className={styles.EURCost}>
          ...
          <div className={styles.EURCostInfo}>
            <span className={styles.EURCostInfoText}>
              <b className={styles.EURCostInfoTextUppercase}>*{t("note")}</b>: {t("exchange_fee")}{" "}
