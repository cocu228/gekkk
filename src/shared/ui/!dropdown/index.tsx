...
export const Dropdown: FC<DropdownProps> = ({ trigger, children, position, customBodyClassName, desktop }) => {
  ...
  return (
    <div
      ref={bodyRef}
      className={`${style.DropdownWrap} ${location.pathname === "/private-room" && desktop && style.DropdownActive} ${
        desktop && style.DropdownWrapDesktop
      }`}
    >
      <div className={style.DropdownTriggerWrap}>
        <div
          className={`${style.DropdownTrigger} ${opened && style.DropdownTriggerOpened}`}
