...
const WithdrawFormCryptoMobile = () => {
    ...
    tokenNetworks.length > 0 && (
      <div className="flex flex-col items-center mt-2">
        <div className="flex flex-col gap-4 text-gray-400 w-full text-left">
          <div className="flex flex-col gap-2">
            ...
            >
              <InputCurrency.PercentSelector
                currency={currency}
                header={
                  <span className="text-[#1F3446] text-[12px] font-bold">
                    {t("amount")}
                  </span>
                }
                onSelect={setInputCurr}
          ...
          <div className="flex flex-row items-center justify-between gap-2">
            <span className="mr-4 text-[#1F3446] text-[12px] font-bold">
              {t("address")}:
            </span>
            <div className="basis-[100%]">
              <Input
...
export default WithdrawFormCryptoMobile;
