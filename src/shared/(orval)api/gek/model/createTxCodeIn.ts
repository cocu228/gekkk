...
export interface CreateTxCodeIn {
  /** Объем операции */
  amount?: number;
  /** Уникальный идентификатор запроса, не должен совпадать с отправленными для исключения повторов.
Число не превышающее int64, например миллисекунды таймера
Unique request identifier. ⚠ Note that you should generate new unique id for each request. */
  clientNonce?: number;
  /**
   * Валюта операции
   * @nullable
