    ...
    <>
      <div className={styles.HeaderWalletDesktop}>
        ...
        <div className={styles.IconInfo}>
          <div className={styles.WalletShortName}>{$const}</div>
        ...
        <div className={styles.IconBalance}>
          <div className={styles.WalletInfoMain}>
            <div
              className={
                styles.WalletInfoMainText + " " + styles.WalletInfoMainTextFree
              }
            >
            ...
            <div
              className={
                styles.WalletInfoMainText +
                " " +
                styles.WalletInfoMainTextOutcome
              }
            >
              <span className={styles.WalletInfoMainText}>
                {t("outcome").capitalize()}:
              </span>
              <span>
                <div>
                  -
            ...
            <div
              className={
                styles.WalletInfoMainText +
                " " +
                styles.WalletInfoMainTextOrders
              }
            >
              <span className={styles.WalletInfoMainText}>
                {t("orders").capitalize()}:
        ...
        {isEUR ? (
          ...
          <div className={styles.IconRate}>
            ...
            <span className={styles.RatePercentText}>
              4% {t("partnership_program.per_annum")}
            </span>
          </div>
        ) : isGKE ? (
          <div className={styles.IconRate}>
            <span className={styles.RateText}>{t("rate")}</span>
            <span className={styles.RatePercentText}>
              5%(or 3%) {t("partnership_program.per_annum")}
            </span>
          </div>
        ) : (
          ""
