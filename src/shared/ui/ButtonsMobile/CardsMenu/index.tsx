                ...
                <div className={`${styles.MobileButton} ${className}`}>
                    <div className="">
                        <svg width="22" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path strokeWidth="1.5" fill="none" d="M 15 15.75 H 3 C 1.725 15.75 0.75 14.775 0.75 13.5 V 4.5 C 0.75 3.225 1.725 2.25 3 2.25 H 15 C 16.275 2.25 17.25 3.225 17.25 4.5 V 13.5 C 17.25 14.775 16.275 15.75 15 15.75"/>
