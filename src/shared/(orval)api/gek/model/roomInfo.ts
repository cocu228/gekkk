 ...
 */
import type { RoomFlags } from "./roomFlags";

export interface RoomInfo {
  /**
   * Количество клиентов подключенных к группе
   * @nullable
   */
  count?: number | null;
  /**
  ...
  flags?: RoomFlags;
  /**
   * Код владельца комнаты, для присоединения участников.
Определяет - является ли пользователь владельцем комнаты или участником
   * @nullable
   */
  room_code?: string | null;
  /** Идентификатор комнаты */
  timetick?: number;
  /** Лимит баланса обмена целевой валюты, для распродаж "не больше x в одни руки" */
