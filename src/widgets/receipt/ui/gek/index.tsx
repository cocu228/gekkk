...
const GekReceipt = (data: IGekRecepit) => (
  <>
    <div className={styles.Header}>
      ...
      <div className={styles.HeaderDate}>{!data?.datetime ? null : formatDateTime(new Date(data.datetime))}</div>
    </div>
          ...
          {!data.addressTxInfo?.txHash ? null : (
            <div className={styles.InformationBlockItem}>
              <span className={styles.InformationBlockItemTitle}>
                Transaction {isNumbersOnly(data.addressTxInfo.txHash) ? "number" : "hash"}
              </span>
