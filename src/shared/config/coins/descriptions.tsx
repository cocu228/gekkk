...
export default {
    ...
    [$const.SHIB]: <div>
        ...
        <br/>
        <p>
            SHIB ranks in the top ten among all meme cryptocurrencies by this measure, right behind Dogecoin.
        </p>
    </div>,
    ...
    [$const.UNI]: <div>
        ...
        <br/>
        <p>
            The Uniswap blockchain is hosted on the Ethereum platform and governed by UNI holders.
        </p>
        <br/>
        <p>
    ...
    [$const.USDT]: <div>
        <p>
            Tether (USDT) is a cryptocurrency stablecoin pegged to the U.S. dollar and backed "100% by Tether's
            ...
            Omni and Liquid protocols as well as the Ethereum, TRON, EOS, Algorand, Solana, OMG Network, 
            and Bitcoin Cash (SLP) blockchains.
        </p>
        <br/>
        <p>
            Tether is used by investors who want to avoid the volatility typical of cryptocurrencies while holding
    ...
    [$const.XMR]: <div>
        ...
        <ul className='pl-[25px] list-disc'>
            <li><a className='font-bold'>Anonymity.</a> Monero transactions are anonymous. It's impossible to find 
                out the balance through its blockchain.</li>
            <li><a className='font-bold'>Security.</a> Complex mathematical solutions protect users' wallets and 
            transactions conducted in Monero coins.</li>
            <li><a className='font-bold'>Decentralization.</a> Monero is not controlled by anyone, 
