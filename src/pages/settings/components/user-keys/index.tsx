    ...
    <MobileWrapper className='w-[90%]'>
      <div className={style.addGekkeyBlock}>
        ...
        <div className={style.CodeWrap}>
          <span className={style.CodeTitle}>{t("confirmation_code")}:</span>
          <Input
            allowDigits
        ...
        {keysList.map((key, index) => (
          <div key={key.id} className={style.keysItem}>
            <div className='w-4/5 overflow-hidden'>
              ...
              <p className={style.keyItemDate}>
                {t("type")}: {key.key_type}
              </p>
              <h4 className={style.keyItemDate}>
      ...
      >
        <span>{keyToRemove ? t("remove_key_warning") : t("close_session_warning")}</span>
