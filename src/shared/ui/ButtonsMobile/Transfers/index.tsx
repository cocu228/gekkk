...
const TransfersButton = memo(({wallet}:IParams) => {
    ...
    const transfersPageCurr = useMatch(`/transfers/${currency}`)
    const isOnTransferPage = !!transfersPage
    const isOnTransferPageCurr = !!transfersPageCurr
