...
const text = {
  ...
  subscribe: {
    404: (
      <p className={hClassName.scss("Desc")}>
        Sorry, but the page you requested was not found or has not yet been created. Go to{" "}
  ...
  return (
    <div className='flex items-center flex-col'>
      <div className={hClassName.scss("Wrapper")}>
        ...
        <div className='row pt-4'>{text.subscribe[code]}</div>
