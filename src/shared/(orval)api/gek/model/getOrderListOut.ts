...
export interface GetOrderListOut {
  /** Остаток целевого объема */
  cur_volume_dest?: number;
  /** Остаток объема источника */
  cur_volume_source?: number;
  /**
   * Валюта источник средств
   * @nullable
   */
  from?: string | null;
  /** Идентификатор */
  ...
  to?: string | null;
  /**
   * Тип ордера обмена 1: Limit 2: Market
   * @nullable
   */
  type_order?: string | null;
  /** Конечный целевой объем обмена */
  volume_dest?: number;
  /** Объем для обмена в источнике */
