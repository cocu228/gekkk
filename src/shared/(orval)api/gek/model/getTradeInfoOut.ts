...
export interface GetTradeInfoOut {
  /**
   * Массив предложения на from
   * @nullable
   */
  asks?: number[][] | null;
  /**
   * Массив спроса на from
   * @nullable
   */
  bids?: number[][] | null;
  /**
   * Настройки обмена flag 0: включена торговля, 1: выключена
   * @nullable
   */
  flags?: string | null;
  /**
   * Валюта источник средств, первое в массиве
   * @nullable
   */
  from?: string | null;
  /** Комиссия площадки с продавца в группе */
  maker_free?: number;
  /**
   * Валюта курсов, третье в массиве
   * @nullable
   */
  price_cur?: string | null;
  /** Приватная комната обмена или 0, если общая */
  room_key?: number;
  /** Комиссия площадки с покупателя в группе */
  taker_free?: number;
  /**
   * Валюта назначения, второе в массиве
   * @nullable
   */
  to?: string | null;
}
