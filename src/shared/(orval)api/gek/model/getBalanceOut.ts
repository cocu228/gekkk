...
export interface GetBalanceOut {
  /**
   * Статус банковского счета: 
"ACTIVE" | "BLOCKED" | "DEBIT BLOCKED" | "IN CLOSURE" | "CLOSED"
   * @nullable
   */
  ...
  /**
   * Баланс обнаруженные на входе сетей, средства в процессе зачисления
   * @nullable
   */
  lock_in_balance?: number | null;
  /**
   * Сумма заблокированные в ордерах
   * @nullable
   */
  lock_orders?: number | null;
  /**
   * Баланс заблокированный на вывод, средства в процессе вывода
   * @nullable
   */
  lock_out_balance?: number | null;
  /**
   * Доступный баланс free + orders
   * @nullable
   */
  user_balance?: number | null;
  /**
   * Доступный примерный баланс в EUR эквивалете(при наличии среднего курса пересчета)
   * @nullable
   */
