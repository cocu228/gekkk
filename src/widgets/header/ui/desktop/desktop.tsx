...
const SvgGekkardLogo = <svg width="100%" height="40px" preserveAspectRatio="xMidYMid meet" viewBox="0 0 137 45" fill="none"
    ...
    return <>
        <header className={styles.Header}>
            <div className={styles.ContainerLogo}>
                <a onClick={() => navigate('/')}>
                    {IS_GEKKARD_APP() ? SvgGekkardLogo : <img src="/img/gekkoin.svg" alt="logo"/>}
                </a>
            </div>
