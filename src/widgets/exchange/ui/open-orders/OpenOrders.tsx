      ...
      <div className={styles.Switch}>
        <span
          className={`${styles.SwitchText} text-${
            activeTab === "Opened" ? "[var(--gek-dark-blue)]" : "[var(--gek-mid-grey)]"
          }`}
        >
        ...
        <span
          className={`${styles.SwitchText} text-${
            activeTab === "Opened" ? "[var(--gek-mid-grey)]" : "[var(--gek-dark-blue)]"
          }`}
        >
          ...
          <div className={styles.CustomDateContainerSecondary}>
            <div className={styles.CustomDateContainerPickers}>
              <div className={styles.DatepickerWrap}>
                <Datepicker date={startDate} setDate={setStartDate} isTo={false} border />
              </div>

              <div className=''>-</div>

              <div className={styles.DatepickerWrap}>
                <Datepicker border date={endDate} setDate={setEndDate} isTo={true} />
              </div>
            </div>
                ...
                <div className='flex justify-between'>
                  <div className='flex gap-2'>
                    <div className='bg-opacity-10 rounded-md flex items-center gap-[4px]'>
                      <span className='font-bold'>{currencyPrecision(ord.volume_source, ord.from)}</span>{" "}
