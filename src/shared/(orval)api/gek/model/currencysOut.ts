 ...
 */
import type { CurrencyFlagsEnum } from "./currencyFlagsEnum";

/**
 * Информация об активе/криптовалюте
 */
export interface CurrencysOut {
  /**
   * Сокращенное название криптовалюты
   * @nullable
   */
  code?: string | null;
  /** Максимальное количество знаков после запятой для хранения актива */
  decimal_prec?: number;
  /** Сеть пополнения по-умолчанию */
  default_token_network_in?: number;
  /** Сеть вывода по-умолчанию */
  default_token_network_out?: number;
  flags?: CurrencyFlagsEnum;
  /** Процентная комиссия на сделки по ордерам с данной валютой */
  market_fee?: number;
  /** Минимальный ордер */
  min_order?: number;
  /**
   ...
   */
  name?: string | null;
  /** Максимальное количество знаков после запятой для задания объема в ордерах. (минимальный шаг торговли) */
  orders_prec?: number;
  /** Приоритет */
  priority?: number;
  /** Количество знаков после запятой для отображения актива (до эквивалента центов) */
  round_prec?: number;
