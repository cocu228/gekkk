...
export type PostGekV1InvestCreateInvestmentParams = {
/**
 * Сумма депозита
 */
amount?: number;
 ...
 */
depo_template_type?: InvestmentsTypeEnum;
/**
 * Срок в днях
 */
term_days?: number;
/**
 * Валюта, к которой привязывается депозит
 */
link_currency?: string;
/**
 * Признак открытия с заморозкой GKE (можно использовать вместо шаблонов > 100)
 */
token_freeze?: boolean;
};
