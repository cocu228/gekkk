        ...
        <form className={styles.filters}>
          ...
          <div className={styles.SelectWrap}>
            ...
            >
              ...
              <div className={`${styles.SelectActive} ${curr && styles.SelectCurrencyActive}`}>
                <div className={styles.SelectPickedValue}>
                  {!curr ? (
                    ...
                    <span className={styles.SelectActiveToken}>
                      <IconCoin height={20} className={`max-h-[36px]`} code={curr} />
            ...
            >
              ...
              <div className={`${styles.SelectActive} ${type && styles.SelectCurrencyActive}`}>
                <div className={styles.SelectPickedValue}>
                  {!type ? (
                    <span className={styles.NonePickedTitle}>-{t("select")}-</span>
                  ) : (
                    <span className={styles.SelectActiveToken}>{type.label}</span>
                  )}
                </div>
                <div className={styles.SelectIconBlock}>
                  <IconApp className='rotate-90' color='#fff' code='t08' size={12} />
            ...
            {fiat && (
              ...
              >
                ...
                <div className={`${styles.SelectActive} ${selectedCard.value && styles.SelectCurrencyActive}`}>
                  <div className={styles.SelectPickedValue}>
                    {!selectedCard.value ? (
                      <span className={styles.NonePickedTitle}>-{t("select")}-</span>
                    ) : (
                      <span className={styles.SelectActiveToken}>{selectedCard.label}</span>
                    )}
                  </div>
                  <div className={styles.SelectIconBlock}>
                    <IconApp className='rotate-90' color='#fff' code='t08' size={12} />
              ...
              {translatedOptions.map(item => (
                ...
                >
                  <div className='ml-5 flex flex-row p-2 gap-5 justify-center items-center '>
                    <span className='text-[12px] h-full flex items-center font-bold'>{item.label}</span>
                  </div>
                </div>
              ))}
            </div>
