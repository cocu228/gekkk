...
const Support = () => {
        ...
        <div className={styles.Choice}>
          <div className={styles.Assets}>
            ...
            <div className='w-full'>
              <a className={styles.Email} target='_blank' href='mailto:support@gekkard.com' rel='noreferrer'>
                <div className={styles.Icon}>
            ...
            <div className='w-full'>
              ...
              >
                ...
                <div className={styles.Main}>
                  ...
                  <div className={styles.MainDescription}>{t("how_can_we_help")}</div>
                </div>
                <div className={styles.Arrow}>
                  <IconApp code='t08' size={12} color='#285E69' />
                </div>
            ...
            <div className='w-full flex justify-end'>
              <span className={styles.ResponseTime}>*{t("response_time_up_to", { hours: 24 })}</span>
            </div>
          </div>
        </div>
  ...
  return (
    <div className='wrapper h-inherit w-full'>
      <PageHead subtitle={t("support.subtitle")} title={t("support.title")} />
      <div
        style={{
          marginBottom: "40px",
          minHeight: "640px"
      ...
      >
        <div className='row flex flex-wrap justify-evenly gap-8 xl:flex-col'>
          ...
          <div className='col w-25 flex flex-col'>
            ...
            <div className='row'>
              <a className='text-lg font-bold' target='_blank' href='mailto:support@gekkard.com' rel='noreferrer'>
                support@gekkard.com
              </a>
            </div>
          </div>
          <div className='col w-25 flex flex-col'>
            ...
            <div className='row'>
              <a className='text-lg font-bold' href='https://t.me/gek_support'>
                https://t.me/gek_support
              </a>
            </div>
          </div>
        </div>
