  ...
  return !isShown ? null : (
    ...
    >
      ...
      <div className='typography-b2' style={{ color: "var(--new-dark-blue)" }}>
        Our website uses cookies. The policy objective is to explain how Papaya (hereafter referred to as “we”) uses
        cookies and processes personal data.
        <div>
      ...
      >
        <button type='button' className='account-button' onClick={acceptCookies}>
          Accept
        </button>
        <button type='button' className='second_value-button' onClick={() => setIsShown(false)}>
          Cancel
        </button>
      </div>
    </div>
