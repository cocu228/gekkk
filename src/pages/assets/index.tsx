  ...
  return (
    <div className='info-box-description'>
      <p className='leading-6'>
        {t("crypto_assets.risks")}{" "}
        <a className='font-bold underline hover:cursor-pointer' onClick={showModal}>
          {t("crypto_assets.deposits")}
        </a>
        .
      </p>
    ...
    <>
      ...
      <div className='wrapper grid grid-cols-1 gap-2 xxl:gap-0'>
        <div className='flex flex-row '>
          <div className={!md ? "substrate w-full col-span-3 z-10 -xl:rounded-r-none" : "w-full"}>
            <AssetsTable
              border={false}
              isModal={false}
              className='w-full'
          ...
          {!xl && (
            <div
              className={`substrate h-full max-w-[400px] -ml-4 z-0 col-span-2 text-gray-600 ${
            ...
            >
              ...
              <div className='row mb-5 flex justify-center'>
                <div className='col flex justify-center'>
                  <span className='text-gray-450 text-center leading-8 max-w-[320px]'>
                    {t("crypto_assets.swap_EURG")}
                  </span>
                </div>
              </div>
