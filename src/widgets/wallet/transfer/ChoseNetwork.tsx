    ...
    <div>
      <div className={styles.Container}>
        {Array.isArray(networksForSelector) && networksForSelector.length < 2 ? null : md ? (
          ...
          <span className='ml-[10px]'>{`${t("select_withdraw_network")}:`}</span>
        ) : (
          <span className='ml-[10px]'>{`${t("select_network")}:`}</span>
        )}
        ...
        <div className='col w-full'>
          {Array.isArray(networksForSelector) && networksForSelector.length === 0 ? (
            ...
            >
              <div className={`${styles.SelectActive} ${network && styles.SelectCurrencyActive}`}>
            ...
            <Select
              ...
              value={
                networkTypeSelect ? networksForSelector.filter(item => item.value === networkTypeSelect)[0].label : 151
              }
