...
function PriceField({ disabled }: { disabled?: boolean }) {
  const { to, from, price, onPriceAmountChange, onPriceCurrenciesSwap } = useContext(CtxExchangeData);
    ...
    <div className={styles.Wrap}>
      {from.currency && to.currency ? (
        <div className={styles.FieldPriceLabel}>
          <button className={styles.FieldSwitchBtn} onClick={onPriceCurrenciesSwap}>
