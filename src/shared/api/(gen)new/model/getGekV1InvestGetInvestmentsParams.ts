...
export type GetGekV1InvestGetInvestmentsParams = {
/**
 * Начальная дата поиска UTC, если не задано - то 90 дней от end
 */
start?: string;
/**
 * Конечная дата выборки UTC, если не задано то текущая
 */
end?: string;
/**
 * Фильтр по типу инвестиции
 */
investment_types?: InvestmentsTypeEnum[];
};
