...
export function OrderConfirmation() {
    ...
    return (state.cardType === 'PLASTIC' && !deliveryOption) ? <Loader className={'relative mt-20'}/> : <>
        ...
        <div className={styles.Container}>
            ...
            <div className={styles.FeeList}>
                <div className={styles.FeeRow}>
                    <span className={styles.FeeTitle} style={{fontWeight: '500'}} >{t("card_issuance")}</span>
                    <span className={styles.FeeValue}>€ 10</span>
                </div>

                <div className={styles.FeeRow}>
                    <span className={styles.FeeTitle} style={{fontWeight: '500'}} >{t("card_delivery")}</span>
            ...
            <div className={styles.ButtonsContainer}>
                ...
                <Button
                    ...
                    text={t("back")}
                    onClick={() => setStep(
                        state.cardType === 'PLASTIC' || !!state.card
                            ? 'DeliveryInfo'
                            : 'IssueNewCard'
                    )}
                />
