 ...
 */
import type { CreateWithdrawStatus } from "./createWithdrawStatus";

export interface CreateWithdrawOut {
  confirmationStatusCode?: CreateWithdrawStatus;
  /** @nullable */
  readonly confirmationStatusText?: string | null;
  /**
   * Используется в схеме с подписью транзакции ключем FIDO2
   * @nullable
   */
  confirmCode?: string | null;
  /**
   * Внутренний ID созданной заявки на вывод
   * @nullable
   */
  create_result?: string | null;
  /** Комиссия транзакции */
  fee?: number;
  /**
   * Сообщение, в котором может содержаться дополнительная информация
   * @nullable
   */
  message?: string | null;
  /**
