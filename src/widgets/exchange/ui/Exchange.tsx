...
function Exchange() {
  ...
  return !roomsList ? (
    ...
    <div className=' '>
        ...
        {!md && (
          <div className={styles.DeskHistoryWrap}>
            <div className={styles.DeskHistoryBody}>
              <span className='text-[12px] hidden xxxl:block ml-[4px] mt-[2px] text-[#29354C] font-bold'>
                {t("last_transactions")}
              </span>
      ...
      {md && (
        <Wrapper className='w-full rounded-lg mt-[15px] flex justify-center px-[10px]'>
          <div className={styles.MobHistoryWrap}>
            <span className='text-[12px] block ml-[19px] mt-[2px] text-[#29354C] font-bold'>
              {t("last_transactions")}
            </span>
            <History className='mb-[50px]' currenciesFilter={historyFilter} types={[2, 15, 16, 20]} />
          </div>
        </Wrapper>
      )}
      <Modal
