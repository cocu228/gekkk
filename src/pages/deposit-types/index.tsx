...
import Rate from "@/widgets/deposit-types/Rate";
import TableRow from "@/widgets/deposit-types/TableRow";
  ...
  return (
    <div className='wrapper'>
      <PageHead
        subtitle={
          <span>
            A modern alternative to a bank deposit. Invest in the Gekkoin virtual products with full or partial
      ...
      <div className='substrate flex flex-col'>
        <section className={!md ? "max-w-[400px]" : ""}>
          <div className='row flex flex-wrap gap-8'>
            <div className='col w-25 flex flex-col'>
              <h2 className={styles.scss("PrimaryHeader")}>Fixed rate deposits</h2>
            </div>
          </div>
          ...
          <div className='row mt-6'>
            <div className='col'>
              <p className='text-gray-400 text-fs14 font-semibold leading-5'>
                The fixed rate deposit allows you to know exactly how much interest you'll earn on your savings over a
                specific period
              </p>
            </div>
          </div>
          ...
          <div
            style={md ? { border: "1px solid #B4C0CD", borderRadius: "4px 4px 0px 0px" } : {}}
        ...
        <section>
          <div className='row flex flex-wrap gap-8 mt-6 mb-2'>
            <div className='col w-25 flex flex-col'>
          ...
          <div className='row grid gap-3 grid-cols-3 xxl:grid-cols-2 lg:grid-cols-1'>
            <div className='col h-full flex flex-col justify-between'>
              <div className='wrapper'>
                <div className='row mt-6'>
                  <div className='col'>
                    <h4 className='font-bold text-lg mb-2'>Safe strategy</h4>
                    <p className='text-gray-400 text-fs14 font-semibold leading-5'>
                      You profit even if the rate drops or grows slowly
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className='col h-full flex flex-col justify-between'>
              <div className='wrapper'>
                <div className='row mt-6'>
                  <div className='col'>
                    <h4 className='font-bold text-lg mb-2'>Balanced strategy</h4>
            ...
            <div className='col h-full flex flex-col justify-between'>
              <div className='wrapper'>
                <div className='row mt-6'>
                  <div className='col'>
                    <h4 className='font-bold text-lg mb-2'>Dynamic strategy</h4>
                    <p className='text-gray-400 text-fs14 font-semibold leading-5'>
                      Good percentage when the rate is rising, limited loss when the rate is falling
                    </p>
                  </div>
                </div>
              </div>
