 ...
 */
import type { AdrTxStateEnum } from "./adrTxStateEnum";
import type { AdrTxTypeEnum } from "./adrTxTypeEnum";

/**
 * Объект с данными об адресной транзакции
 */
export interface AddressTxOut {
  ...
  /** Размер транзакции (decimal) */
  amount?: number;
  /** Блок, в котором транзакция, если есть */
  blockNum?: number;
  ...
  /**
   * Базовый адрес эксплорера транзакций
   * @nullable
   */
  explorerBaseAddress?: string | null;
  /** Комиссия сети за транзакцию (decimal) */
  fee?: number;
  /** Последний прочитанный блок */
  lastBlock?: number;
  state?: AdrTxStateEnum;
  /**
   * Набор статусов транзакции в строке
   * @nullable
   */
  state_text?: string | null;
  /**
   * Сеть, в которой отправлена транзакция
   * @nullable
   */
  tokenNetwork?: string | null;
  /**
   * Хэш транзакции в блокчейн, если есть
   * @nullable
   */
  txHash?: string | null;
  txType?: AdrTxTypeEnum;
  /** Время последнего обновления (В UTC) */
  updated?: string;
}
