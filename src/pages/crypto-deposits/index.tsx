                            ...
                            <div className="wrapper">
                                <div className="row mt-6">
                                    <div className="col">
                                        ...
                                        <p className="text-gray-400 text-fs14 font-semibold leading-5">You profit even if the rate drops or
                                            grows
                                            slowly</p>
                                    </div>
                                </div>
                            ...
                            <div className="wrapper">
                                <div className="row mt-6">
                                    <div className="col">
                                        ...
                                        <p className="text-gray-400 text-fs14 font-semibold leading-5">Good percentage when the rate is
                                            rising, limited
                                            loss
