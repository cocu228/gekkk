...
export const ChangePasswordForm = ({ emailCodeDefault, handleCancel }: IParams) => {
  ...
  return (
    <main className={styles.ResetForm}>
              ...
              {!isGekkey ? (
                ...
                <>
                  <p className={styles.Description}>
                    To increase the security of your account, we suggest using a hardware storage-based access key.{" "}
              ...
              <div className={styles.rulesList}>
                {!isGekkey ? (
                  <>
                    ...
                    <div>
                      <div className={styles.rulesListH}>ℹ check list ℹ</div>
                    </div>
                  </>
                ) : (
                  ""
        ...
        <div className={styles.FormButtons}>
          <Button
            ...
            disabled={
              loading ||
              !emailCode ||
              (smsSended && (!smsCode || (!isGekkey && (password !== passwordConfirm || !isValid))))
            }
          >
            {!smsSended ? "Send SMS" : isGekkey ? "Register gekkey" : "Reset password"}
          </Button>
