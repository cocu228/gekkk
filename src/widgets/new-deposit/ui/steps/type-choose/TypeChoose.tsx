...
const TypeChoose = memo(() => {
    ...
    const onModalClick = async () => {
        ...
        actionResSuccess(response).success(() => {
            window.open(`${gekkardUrl ?? 'https://dev.gekkard.com'}/wallet/${redirectCurrency}/Top Up?sessionId=${uncoverResponse(response)}`, "_blank")
        })
    ...
    return (
        <div className="px-10 mt-10 md:mt-4 md:px-4">
            ...
            <div className="wrapper grid grid-cols-2 gap-6 mb-8 w-full xxl:justify-between md:mb-4">
                ...
                <div className="wrapper col-span-2 mb-5 hidden xl:block md:mb-5">
                    {descriptions[type]}
                </div>
                ...
                <div>
                    <Checkbox
                        className='md:mr-10'
                        onChange={onIsGkeDepositChange}
                        defaultChecked={isGke}
                    >
