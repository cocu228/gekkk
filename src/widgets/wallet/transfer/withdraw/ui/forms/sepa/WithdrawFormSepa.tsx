  ...
  return (
    <div className='wrapper'>
      ...
      <Modal destroyOnClose isModalOpen={isModalOpen} onCancel={handleCancel} title={t("confirm_transaction")}>
        <WithdrawConfirmSepa {...inputs} handleCancel={handleCancel} amount={inputCurr.value.number} />
      </Modal>
      ...
      <div className={styles.ButtonContainerCenter}>
        ...
        <div className={styles.BottomFeeInfo}>
          <span className={styles.BottomFeeInfoText}>
            {t("fee_is_prec")} <span className={styles.BottomFeeInfoTextBold}>{withdraw_fee} EURG</span>{" "}
            {t("per_transaction")}
          </span>
        </div>
      </div>
