 ...
 * Generic electronic key multi-cryptocurrency broker wallet platform with a built-in exchange.<br/>
                    Build version 2.0.3-20240715-0818.9450+58cd46cf70debd7d0ff511fbfd39f9ec8c899337<br/><br/>
...
import type {
  ...
  PostGekV1BankActivateParams,
  PostGekV1BankConfirmPaymentToBrokerParams,
  PostGekV1BankGetUasParams,
  PostGekV1BankPersonalizeParams,
  PostGekV1BankSetLimitsParams,
  PostGekV1BankSetPinParams,
  PostGekV1BankSubmitDealParams,
...
import postGekV1BankInitiatePaymentToBrokerMutator from '../../lib/(orval)axios';
import postGekV1BankConfirmPaymentToBrokerMutator from '../../lib/(orval)axios';
...
/**
 * @summary Creates the draft of a payment to cryptobroker (Gekkard only)
 */
export const apiInitiatePaymentToBroker = (
    paymentData: PaymentData,
 options?: SecondParameter<typeof postGekV1BankInitiatePaymentToBrokerMutator>,) => {
      return postGekV1BankInitiatePaymentToBrokerMutator<CreateWithdrawOutApiResponse>(
      {url: `/gek/v1/bank/initiate_payment_to_broker`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: paymentData
    },
      options);
...
/**
 * @summary Confirmes previously created draft (Gekkard only)
 */
export const apiConfirmPaymentToBroker = (
    paymentData: PaymentData,
    params?: PostGekV1BankConfirmPaymentToBrokerParams,
 options?: SecondParameter<typeof postGekV1BankConfirmPaymentToBrokerMutator>,) => {
      return postGekV1BankConfirmPaymentToBrokerMutator<TxConfirmResApiResponse>(
      {url: `/gek/v1/bank/confirm_payment_to_broker`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: paymentData,
        params
    },
...
export type ApiInitiatePaymentToBrokerResult = NonNullable<Awaited<ReturnType<typeof apiInitiatePaymentToBroker>>>
export type ApiConfirmPaymentToBrokerResult = NonNullable<Awaited<ReturnType<typeof apiConfirmPaymentToBroker>>>
