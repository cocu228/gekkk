    ...
    <div>
      ...
      <div className={styles.Code}>
        ...
        <div className={styles.CodeButtonWrapper}>
          <Button className={"w-full"} disabled={input === "" || loading} onClick={showModal} size={"md"}>
            {t("apply")}
          </Button>

          <Modal
            placeBottom={window.innerWidth < 768}
            title={infoCode ? t("code_applied_successfully") : t("transfer_code_info")}
                ...
                <div className='row mb-12'>
                  <div className='col'>
                    <p className='text-xl text-green'>
                      {infoCode.amount} {infoCode.currency}
                    </p>
                  </div>
                </div>
                <div className='row'>
