  ...
  return (
    ...
    <>
      <div className={styles.Header}>
        <div className={styles.LogoContainer}>{modeInfo.icon}</div>
        <div
          onClick={() => {
      ...
      <div className={styles.Main}>
        <div className={styles.Body}>
          <header>
            <h2>{form === "LOGIN" ? modeInfo.title : "Password reset form"}</h2>
            <p>
              {form === "LOGIN"
          ...
          <footer>
            ...
            <p>Crypto exchange service is powered by AtlantEX OU (licensed partner for crypto wallet and exchange)</p>
