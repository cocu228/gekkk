...
function ModalTrxStatusSuccess({ onReceipt = null }: IParams) {
  ...
  return (
    <div className='w-full flex flex-col gap-[30px] items-center my-8 md:mb-4'>
      ...
      <div className='text-center w-[80%] flex flex-col items-center gap-[30px]'>
        <span className='font-bold text-[20px] text-[#3A5E66]'>{t("success")}!</span>
      ...
      <div
        className={`${
          onReceipt !== null ? styles.ButtonContainer : styles.ButtonContainerCenter
        } flex gap-[20px] align-center mt-[10px] md:mt-[30px] px-4`}
      >
        {onReceipt === null ? null : (
          <Button skeleton className='w-full' onClick={onReceipt}>
