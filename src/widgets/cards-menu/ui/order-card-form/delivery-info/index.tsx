...
export function DeliveryInfo() {
  ...
  const { state, close, setStep, setState, switchResidenceAddress } = useOrderCardContext();
      ...
      <ExtendedSelect
        ...
        preContent={
          <div className={styles.SwitchContainer}>
            ...
            <Switch onChange={switchResidenceAddress} defaultCheked={state.isResidenceAddress} />
          </div>
        }
      >
        <div className={styles.Container}>
          ...
          <div className={styles.ButtonsContainer}>
            ...
            <Button
              skeleton
              className='w-full'
              onClick={() => (state.cardholderName ? setStep("IssueNewCard") : close())}
            >
              {t("back")}
            </Button>
          </div>
