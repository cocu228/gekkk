...
const RiskChoose = () => {
  const { structuredStrategy, onRiskLevelChange } = useContext(CtxNewDeposit);

  return (
    <div className='px-10 mt-5 md:px-3 md:my-3'>
      <p className='text-gray-400 mb-2 font-medium text-base md:text-sm'>Choose the risk level</p>
          ...
          >
            <div className='flex flex-col items-start text-start gap-3 justify-between h-full w-full md:items-center'>
              <div>
                ...
                <p className='text-gray-400 text-sm md:hidden'>{strategy.descriptionShort}</p>
              </div>
